...
impl AICodeQualityStats {
    pub fn calculate_quality_score(&mut self, code: &str) -> f64 {
        ...
        self.quality_factors = vec![
            QualityFactor { name: "Readability".to_string(), score: readability, weight: 0.3 },
            QualityFactor { name: "Maintainability".to_string(), score: maintainability, weight: 0.3 },
            QualityFactor { name: "Performance".to_string(), score: performance, weight: 0.2 },
            QualityFactor { name: "Security".to_string(), score: security, weight: 0.2 },
        ];
