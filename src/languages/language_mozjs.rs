...
pub enum Mozjs {
    ...
    YieldExpression = 180,
    Object = 181,
    ObjectCodePattern = 182,
    AssignmentCodePattern = 183,
    ObjectAssignmentCodePattern = 184,
    Array = 185,
    ArrayCodePattern = 186,
    JsxElement = 187,
    JsxExpression = 188,
    ...
    ObjectRepeat1 = 246,
    ObjectCodePatternRepeat1 = 247,
    ArrayRepeat1 = 248,
    ArrayCodePatternRepeat1 = 249,
    ...
    ShorthandPropertyIdentifierCodePattern = 262,
...
impl From<Mozjs> for &'static str {
    ...
    fn from(tok: Mozjs) -> Self {
        match tok {
            ...
            Mozjs::ShorthandPropertyIdentifierCodePattern => {
