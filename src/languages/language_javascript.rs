...
pub enum Javascript {
    ...
    YieldExpression = 179,
    Object = 180,
    ObjectCodePattern = 181,
    AssignmentCodePattern = 182,
    ObjectAssignmentCodePattern = 183,
    Array = 184,
    ArrayCodePattern = 185,
    JsxElement = 186,
    JsxExpression = 187,
    ...
    ObjectRepeat1 = 245,
    ObjectCodePatternRepeat1 = 246,
    ArrayRepeat1 = 247,
    ArrayCodePatternRepeat1 = 248,
    ...
    ShorthandPropertyIdentifierCodePattern = 261,
...
impl From<Javascript> for &'static str {
    ...
    fn from(tok: Javascript) -> Self {
        match tok {
            ...
            Javascript::ShorthandPropertyIdentifierCodePattern => {
